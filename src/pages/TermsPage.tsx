...
const S = {
  ...
  sticky: { position: "sticky", top: 0, zIndex: 20, background: "#040c18", borderBottom: "1px solid rgba(0,180,255,0.15)", padding: "14px 20px" } as React.CSSProperties,
  ...
  sub: { fontSize: "0.82rem", color: "#5b8db8", marginBottom: 0 } as React.CSSProperties,
  ...
  divider: { borderColor: "rgba(0,180,255,0.12)", margin: "32px 0" } as React.CSSProperties,
  tabBtn: (active: boolean): React.CSSProperties => ({
    flex: 1, height: 40, borderRadius: 10, fontWeight: 900, fontSize: "0.85rem",
    border: "none", cursor: "pointer", transition: "all 0.15s",
    background: active ? "linear-gradient(135deg, #00b4ff, #0047ab)" : "rgba(255,255,255,0.06)",
    color: active ? "#000d1a" : "#5b8db8",
  }),
};
  ...
  return (
    <>
      <div style={{ textAlign: "center", padding: "32px 0 28px", borderBottom: "1px solid rgba(240,160,48,0.12)", marginBottom: 28 }}>
        ...
        <p style={S.sub}>P.O.S. Pro · Last updated: August 2026</p>
      </div>

      <p style={S.p}>
        By creating an account or using P.O.S. Pro, you agree to be bound by these Terms and Conditions. Please read them carefully before using the platform.
      </p>

      <h3 style={S.h3}>1. Acceptance of Terms</h3>
      <p style={S.p}>
        These Terms and Conditions ("Terms") constitute a legally binding agreement between you ("Owner", "User") and P.O.S. Pro ("we", "us", "our"). Accessing or using the app constitutes full acceptance of these Terms.
      </p>
      ...
      <ul style={S.ul}>
        <li style={S.li}>Access to P.O.S. Pro requires a paid subscription. Plans and pricing are published within the app.</li>
      ...
      <p style={S.p}>
        P.O.S. Pro is licensed solely for use as a bar and hospitality point-of-sale management tool for legitimate business operations. You may not:
      </p>
      <ul style={S.ul}>
      ...
      <p style={S.p}>
        As an Owner you may create Cashier and Manager accounts. You accept full responsibility for the actions of your staff within the platform. P.O.S. Pro is not liable for losses arising from staff misuse of their accounts.
      </p>

      <h3 style={S.h3}>6. Data Ownership</h3>
      <p style={S.p}>
        You retain full ownership of the business data you enter into P.O.S. Pro (products, sales, customers, expenses). We do not claim any rights over your data. We process it solely to deliver the service as described in our Privacy Policy.
      </p>
      ...
      <p style={S.p}>
        To the maximum extent permitted by law, P.O.S. Pro shall not be liable for any indirect, incidental, special, consequential, or punitive damages — including lost profits, lost revenue, or loss of data — arising from your use or inability to use the platform.
      </p>
      ...
      <p style={S.p}>
        Questions about these Terms? Email us at <span style={{ color: "#00b4ff" }}>support@pospro.app</span>.
      </p>
    </>
  );
}
...
function TermsOfUse() {
  return (
    <>
      ...
      <p style={S.p}>
        These Terms of Use govern your day-to-day interaction with the P.O.S. Pro app, including acceptable conduct, prohibited activities, and your rights as a user.
      </p>
      ...
      <p style={S.p}>
        All software, design, graphics, trademarks, and content comprising P.O.S. Pro are the exclusive property of P.O.S. Pro or its licensors. Nothing in these Terms grants you any rights in our intellectual property other than the limited license to use the platform as described.
      </p>

      <h3 style={S.h3}>5. Third-Party Services</h3>
      <p style={S.p}>
        P.O.S. Pro integrates with third-party services (Supabase, YouTube, push notification providers). Your use of those integrations is subject to the respective providers' terms of service. We are not responsible for the availability or conduct of third-party services.
      </p>
      ...
      <p style={S.p}>
        If you become aware of any violation of these Terms, please report it to <span style={{ color: "#00b4ff" }}>support@pospro.app</span>. We take violations seriously and will investigate all reports.
      </p>
      ...
      <p style={S.p}>
        P.O.S. Pro is provided "as is" and "as available" without warranties of any kind, express or implied, including warranties of merchantability, fitness for a particular purpose, or non-infringement. We do not warrant that the app will be error-free or uninterrupted.
      </p>

      <h3 style={S.h3}>10. Contact</h3>
      <p style={S.p}>
        For questions about these Terms of Use, contact <span style={{ color: "#00b4ff" }}>support@pospro.app</span>.
      </p>
    </>
  );
}
    ...
    <div style={S.page}>
      ...
      <div style={S.sticky}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
          <button
            onClick={() => nav(-1)}
            style={{ background: "rgba(255,255,255,0.06)", border: "none", borderRadius: 8, width: 32, height: 32, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#00b4ff", flexShrink: 0 }}
          >
            <ArrowLeft size={16} />
          </button>
          <FileText size={20} color="#00b4ff" />
